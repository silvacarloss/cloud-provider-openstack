...
func getAccessRightBasedOnShareAdapter(shareAdapter shareadapters.ShareAdapter, accessRights []shares.AccessRight, shareAccessIDs string) (accessRight *shares.AccessRight) {
	switch shareAdapter.(type) {
	case *shareadapters.Cephfs:
		shareAccessIDs := strings.Split(shareAccessIDs, ",")
